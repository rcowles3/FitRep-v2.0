...
export const healthCodes = [
  {code: 1, title: 'To look for a friend'},
  {code: 2, title: 'To look for paid employment opportunities'},
  {code: 3, title: 'To look for someone to work out with'},
  {code: 4, title: 'None of the above'}
]
